...
- Every other category (`1-project/`, `2-database/`, `3-api/`, `4-ui/`, `5-modules/`, `6-development/`) fully generated and approved. This category runs **last**, always — its two documents cross-check decisions made everywhere else.
